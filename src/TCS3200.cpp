...
Colour TCS3200::getColour(RGB rgb) {
  ...
  std::cout << red.red << ":" << red.green << ":" << red.blue << std::endl;
  if ((rgb.red >= (red.red-diff) && rgb.red <= (red.red+diff)) && (rgb.green >= (red.green-diff) && rgb.green <= (red.green+diff)) && (rgb.blue >= (red.blue-diff) && rgb.red <= (red.blue+diff))) {
    colour = RED;
